...
public class TestDicoSD {
	...
	public static void main(String[] args) {
		...
		// test7 : supprime pil e- urlPile1 dans le dico qui contient pile - urlPile1, pile - urlPile2, ensemble - urlEnsemble1
		assertEquals("Test7 ko : le dico contient pile - urlPile1 et urlPile2, on supprime pile - urlPile1  suppression? ",true, dico.supprimer("pile", "urlPile1"));
		assertEquals("Test7 ko : le dico contient pile - urlPile1 et urlPile2, on supprime pile - urlPile1  contenu? ","[urlPile2]", dico.lesURLs("pile"));
		assertEquals("Test7 ko : le dico contient pile - urlPile1 et urlPile2, on supprime pile - urlPile1  pile present? ",true, dico.contient("pile"));

		// test8 : supprime pile - urlPile2 dans le dico qui contient pile - urlPile2, ensemble - urlEnsemble1
		assertEquals("Test8 ko : le dico contient pile - urlPile2, on supprime pile - urlPile2  suppression? ",true, dico.supprimer("pile", "urlPile2"));
		assertEquals("Test8 ko : le dico contient pile - urlPile2, on supprime pile - urlPile2  contenu? ","[]", dico.lesURLs("pile"));
		assertEquals("Test8 ko : le dico contient pile - urlPile2, on supprime pile - urlPile2  pile present? ",false, dico.contient("pile"));

 ...
 */
public class TestDequeImplChainee {
	...
	private static void testAjouterEnPremier() {
		...
		DequeImplChainee<String> dVide = new DequeImplChainee<String>();
		try{
		...
		String[] tbcd = {"b","c","d"};
		DequeImplChainee<String> dbcd = new DequeImplChainee<String>(tbcd);
		try{
		...
		String[] tcd = {"c","d"};
		DequeImplChainee<String> dcd = new DequeImplChainee<String>(tcd);
		try{
	...
	private static void testRetirerPremier() {
		...
		String[] tabc = {"a","b","c"};
		DequeImplChainee<String> dabc = new DequeImplChainee<String>(tabc);
		try{
		...
		String[] ta = {"a"};
		DequeImplChainee<String> da = new DequeImplChainee<String>(ta);
		try{
	...
	private static void testAjouterEnDernier() {
		...
		String[] tab = {"a","b"};
		DequeImplChainee<String> dab = new DequeImplChainee<String>(tab);
		try{
